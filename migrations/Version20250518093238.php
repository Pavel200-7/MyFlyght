 ...
 */
final class Version20250518093238 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX idx_54469df443b37cb2
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE tickets DROP flights_id
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE tickets ADD flights_id INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
