...
export class seatShablonPrinter
{
    ...
    {
        this.clearSeatShablonVisual();
        this.printSeatShablonFromObject_client(seatStructure, ticketsOrderListObj);
        console.log(ticketsOrderListObj);

    }

    printSeatShablonFromObject_client(seatStructureObject, ticketsOrderListObj) {
        this.visualDiscription.innerHTML = this.printSeatShablonFromObject_GetHTML_client(seatStructureObject);
